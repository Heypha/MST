...
with open('D:/PycharmProjects/mst/trained_model_hue.pkl', 'rb') as file:
    models.append(pickle.load(file))
class_names_list.append(['Cool', 'Warm'])

# Model 2: Load and append to models and class_names_list
with open('D:/PycharmProjects/mst/trained_model_saturation15.pkl', 'rb') as file:
    models.append(pickle.load(file))
class_names_list.append(['Bright', 'Muted'])

# Model 3: Load and append to models and class_names_list
with open('D:/PycharmProjects/mst/trained_model_value_bw.pkl', 'rb') as file:
    models.append(pickle.load(file))
class_names_list.append(['Dark', 'Light', 'Mid'])
...
# Example usage
process_image_folder("D:/PycharmProjects/mP2/TrainData", 'D:/PycharmProjects/mst/output_change2.json', 'D:/PycharmProjects/mst/dest_test')
