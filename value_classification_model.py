...
data = pd.read_csv("D:/PycharmProjects/mP2/value_dataset.csv")
image_files = data['Image Path']
labels = data['Label']

# Split the data into training, validation, and test sets
train_files, test_files, train_labels, test_labels = train_test_split(image_files, labels, test_size=0.3, random_state=64)
train_files, val_files, train_labels, val_labels = train_test_split(train_files, train_labels, test_size=0.15, random_state=64)

# Destination directory
destination_directory = 'D:/PycharmProjects/mP2/destination_value'
...
# cropped_train_dir = "D:/PycharmProjects/mP2/destination_saturation/train_set_cropped"
# cropped_test_dir= "D:/PycharmProjects/mP2/destination_saturation/test_set_cropped"
# cropped_val_dir= "D:/PycharmProjects/mP2/destination_saturation/val_set_cropped"
...
# Save data
with open('trained_model_value_new_bw.pkl', 'wb') as file:
...
with open('test_results_value_new_bw.json', 'w') as file:
